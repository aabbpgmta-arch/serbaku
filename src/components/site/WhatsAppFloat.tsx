...
export function WhatsAppFloat() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 grid h-14 w-14 place-items-center rounded-full bg-[oklch(0.72_0.16_152)] text-white shadow-elegant transition hover:scale-105"
    >
