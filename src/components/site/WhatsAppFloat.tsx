...
export function WhatsAppFloat() {
  ...
  if (!num) return null;
  const href = `https://wa.me/${num}?text=${encodeURIComponent("Halo Toko Serba, saya ingin tanya produk grosir.")}`;
  return (
    <a
      href={href}
      target="_blank"
